...
<template>
  ...
  <div class="flex justify-center items-center h-[calc(100vh-54.5px)]">
    <div
      class="flex my-auto flex-col justify-center border-[var(--primary)]/20 border w-1/3 mx-auto p-10 rounded-xl backdrop-blur-md"
    >
      <template v-if="appState.activeTab === ActiveTab.LOGIN">
        ...
        <div class="flex relative flex-col w-full">
          <div class="form-group h-full" :class="{ '!mb-5': login$.nick.$error }">
            <div class="input-wrapper flex">
              <i class="fa fa-user absolute top-1/2 -translate-y-1/2 ml-3 text-[var(--primary)]" />
              <input
          ...
          <div class="form-group h-full" :class="{ '!mb-5': login$.password.$error }">
            <div class="input-wrapper flex">
              <i class="fa fa-lock absolute top-1/2 -translate-y-1/2 ml-3 text-[var(--primary)]" />
              <input
        ...
        <button class="btn-microsoft" @click="handleLogin({ accountType: AccountType.MICROSOFT })">
